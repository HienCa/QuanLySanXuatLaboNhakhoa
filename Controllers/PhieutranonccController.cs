...
namespace QuanLySanXuat.Controllers
{
    public class PhieutranonccController : Controller
    {
        ...
        public PhieutranonccController(ProductionManagementSoftwareContext context)
        {
            _context = context;
        }
        ...
        {
            return View(await _context.Phieutranoncc.Where(n => n.Active == 1).Include(ht=>ht.IdhtttNavigation).ToListAsync());
        }
        ...
        public async Task<IActionResult> Create(int Idptnncc, Phieutranoncc ptn, string action)
        {
